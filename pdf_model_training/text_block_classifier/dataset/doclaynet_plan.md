...
```text
pdf_model_training/text_block_classifier/local_only/datasets/doclaynet/
```
...
python3 markitdown-quality-lab/pdf_model_training/text_block_classifier/adapters/doclaynet_adapter.py \
  --annotations pdf_model_training/text_block_classifier/local_only/datasets/doclaynet/core/COCO/train.json \
  --text-cells-root pdf_model_training/text_block_classifier/local_only/datasets/doclaynet/extra/JSON \
