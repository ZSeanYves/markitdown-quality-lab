...
def main():
    ...
    parser.add_argument("--train-summary", default=".tmp/pdf_model_training/eval/train_summary.tsv")
    parser.add_argument("--heldout-summary", default=".tmp/pdf_model_training/eval/heldout_summary.tsv")
    parser.add_argument("--confusion", default=".tmp/pdf_model_training/eval/confusion.tsv")
    parser.add_argument("--errors", default=".tmp/pdf_model_training/eval/errors.tsv")
    parser.add_argument("--pred-dir", default=".tmp/pdf_model_training/predictions")
